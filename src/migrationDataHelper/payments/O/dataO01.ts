...
export async function  dataPaymentO01_up(queryRunner: QueryRunner): Promise<void> {
    const contractID:number = 501
    if(false)
    await queryRunner.query(`UPDATE contract SET "sheduleAmount" = 
        ...
        WHERE id = ${contractID}`)
    const payments = [
        {date:'2023-01-25', amount:16500},
        {date:'2023-02-18', amount:25000}
    ]
