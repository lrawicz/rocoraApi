...
export async function  dataPaymentB01_up(queryRunner: QueryRunner): Promise<void> {
    const contractID:number = 201
    if(false)
    await queryRunner.query(`UPDATE contract SET "sheduleAmount" = 
        ...
        WHERE id = ${contractID}`)
    const payments = [
        {date:'2023-01-11',amount: 16000},{date:'2023-01-18',amount: 39000},{date:'2023-01-25',amount: 26000},
        {date:'2023-02-11',amount: 60000}
    ]
