...
export async function  dataPaymentVL14_up(queryRunner: QueryRunner): Promise<void> {
    const contractID:number = 114
    if(false)
    await queryRunner.query(`UPDATE contract SET "sheduleAmount" = 
        ...
        WHERE id = ${contractID}`)
    const payments = [
            {date:'2023-01-25',amount:25000},
            {date:'2023-02-25',amount:25000}
    ]
