...
export async function  dataPaymentVL09_up(queryRunner: QueryRunner): Promise<void> {
    const contractID:number = 109
    if(false)
    await queryRunner.query(`UPDATE contract SET "sheduleAmount" = 
        ...
        WHERE id = ${contractID}`)
    const payments = [
        {date:'2023-01-18',amount: 22000},
        {date:'2023-02-18',amount: 22000}
    ]
