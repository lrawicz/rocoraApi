...
export async function  dataPaymentVL06_up(queryRunner: QueryRunner): Promise<void> {
    const contractID:number = 106
    if(false)
    ...
    const payments = [
        ...
        {date:'2023-02-18',amount: 30000},{date:'2023-02-25',amount: 30000}
    ]
