...
export async function  dataPaymentVL04_up(queryRunner: QueryRunner): Promise<void> {
    const contractID:number = 104
    if(false)
    await queryRunner.query(`UPDATE contract SET "sheduleAmount" = 
        ...
        WHERE id = ${contractID}`)
    const payments = [
            {date:'2023-01-11',amount: 21000},{date:'2023-01-25',amount: 9000},
