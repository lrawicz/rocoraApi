...
export async function  dataPaymentVL02_up(queryRunner: QueryRunner): Promise<void> {
    const contractID:number = 102
    if(false)
    await queryRunner.query(`UPDATE contract SET "sheduleAmount" = 
        ...
        WHERE id = ${contractID}`)
    const payments = [
        {date:'2023-01-01',amount: 20000},{date:'2023-01-25',amount: 4000},
        {date:'2023-02-01',amount: 190000},{date:'2023-01-18',amount: 5000}
