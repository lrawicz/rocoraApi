...
export class S08_1755474827408 implements MigrationInterface {
    contractID:number = 408
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        ('2023-01-01', 50000,$1),('2023-01-11', 10000,$1),('2023-01-18', 15000,$1),
        ('2023-02-01', 50000,$1),('2023-01-18', 15000,$1),('2023-01-25', 10000,$1),
