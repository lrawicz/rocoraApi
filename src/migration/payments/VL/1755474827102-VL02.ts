...
export class VL02_1755474827102 implements MigrationInterface {
    contractID:number = 102
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO "payment"
            ...
            ('2023-01-01', 20000,$1),('2023-01-25', 4000,$1),
            ('2023-02-01', 190000,$1),('2023-01-18', 5000,$1),
            `,
        [this.contractID])
